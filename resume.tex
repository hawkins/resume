...
\item Extends the CPython embedded interpreter to create performant Python packages implemented in C \& C++
% TODO: Talk about the field I work in, how I've provided input to new architecture decisions with my Node internals knowledge
\end{tightemize}

...
\urlstyle{same}\href{http://hawkins.github.io}{http://hawkins.github.io}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Objective}
\location{Passionate JavaScript \& React Developer seeking work experience as a Front-end Web Developer}
\sectionsep
